...
using ProjectFlotillas.Business.Common;
...
namespace ProjectFlotillas.Business
{
    public class ProductBusinessService
    {
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        public List<Product> GetProductsCompi(int currentPageNumber, int pageSize, string sortExpression, string sortDirection, out TransactionalInformation transaction)
        {
            transaction = new TransactionalInformation();
