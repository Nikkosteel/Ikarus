...
namespace ProjectFlotillas.Portal
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/shared").Include(
               "~/Views/Shared/ProjectFlotillasBootstrap.js",
            ...
            bundles.Add(new ScriptBundle("~/bundles/routing-debug").Include(
              "~/Views/Shared/ProjectFlotillasRouting-debug.js"
          ));

            bundles.Add(new ScriptBundle("~/bundles/routing-production").Include(
             "~/Views/Shared/ProjectFlotillasRouting-production.js"
         ));
            ...
            bundles.Add(new ScriptBundle("~/bundles/products").Include(      
                ...
                //,"~/Views/Products/ProductPopUpController.js"
            ));
