...
console.log("project Flotillas routing - production");

angular.module("projectFlotillas").config(['$routeProvider', '$locationProvider', 'applicationConfigurationProvider',
